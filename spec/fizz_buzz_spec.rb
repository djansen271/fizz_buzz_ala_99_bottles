describe FizzBuzz do
  ...
  describe '#single_verse' do
    ...
    it 'returns FizzBuzz given 15' do
      expect(subject.single_verse(15)).to eq(fizzbuzz_respone)
    end
    ...
    it 'returns FizzBuzz given 45' do
      expect(subject.single_verse(45)).to eq(fizzbuzz_respone)
    end
  end
  ...
  describe '#song' do
    it 'returns 1,2,Fizz,4,Buzz,6,7,..Fizz,100' do
      expect(subject.song).to eq(
        %W( 1  2  #{fizz_response} 4  %{buzz_response} #{fizz_response} 7  8  #{fizz_response} #{buzz_response} 11 #{fizz_response} 13 14 %{fizzbuzz_response}
